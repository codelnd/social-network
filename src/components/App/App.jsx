        ...
        <div className={s.container}>
            ...
            <Main>
                <Routes>
                    ...
                    <Route path='/messages/*' element={<Messages messagesPage={props.state.messagesPage} newMessage={props.state.messagesPage.newMessage} dispatch={props.dispatch}/>}></Route>
